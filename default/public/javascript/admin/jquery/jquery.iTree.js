 ...
 * 
 * Extended by C.Caballero
 */

(function($) {
	
	$.widget("ui.iTree", $.extend({}, $.ui.sortable.prototype, {
		...
		_create: function() {
			this.element.data('sortable', this.element.data('iTree'));
		...
		_refreshIcons: function() {	
			...
			$(this.element).children('li').each(function(){	
				...
				if ($(this).children(me.options.listType) && $(this).children(me.options.listType).children('li').length) {
	...
	$.ui.iTree.prototype.options = $.extend({}, $.ui.sortable.prototype.options, $.ui.iTree.prototype.options);
